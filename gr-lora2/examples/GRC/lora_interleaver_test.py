...
class lora_interleaver_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.lora2_lora_interleaver_0 = lora2.lora_interleaver(SF, CR, True)
        self.lora2_lora_deinterleaver_0 = lora2.lora_deinterleaver(SF, CR, True)
        ...
        self.connect((self.blocks_unpack_k_bits_bb_0, 0), (self.lora2_lora_interleaver_0, 0))
